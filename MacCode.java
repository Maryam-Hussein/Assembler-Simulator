        ...
        while ((text = bufferedReader.readLine()) != null) {
            ...
            for (int i = 1; i < ABC.length; i++) // ABC is name of Array of Strings --> input.txt
            {
                ...
                else if(ABC[i].equals("BYTE"))
                {
                    ...
                    {
                        if (ABC[b].equals("A")){System.out.println(B.get("A"));bufferedWriter.write(B.get("A"));}
                        else if (ABC[b].equals("B")){System.out.printf(B.get("B"));bufferedWriter.write(B.get("B"));}
                        else if (ABC[b].equals("C")){System.out.printf(B.get("C"));bufferedWriter.write(B.get("C"));}
                        else if (ABC[b].equals("D")){System.out.println(B.get("D"));bufferedWriter.write(B.get("D"));}
                    }
                    bufferedWriter.newLine();
                }
