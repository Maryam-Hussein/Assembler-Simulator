        ...
        while ((text = bufferedReader.readLine()) != null) {
            ...
            for (int i = 1; i < ABC.length; i++) // ABC is name of Array of Strings --> input.txt
            {
                ...
                /////////////////////////////////////////////////////////////////////////////////////////////////
                    ...
                    {
                        if (ABC[b].equals("A")) {
                            System.out.printf(B.get("A"));
                            bufferedWriter.write(B.get("A"));
                            LOC++;
                        } else if (ABC[b].equals("B")) {
                            System.out.printf(B.get("B"));
                            bufferedWriter.write(B.get("B"));
                            LOC++;
                        } else if (ABC[b].equals("C")) {
                            System.out.printf(B.get("C"));
                            bufferedWriter.write(B.get("C"));
                            LOC++;
                        } else if (ABC[b].equals("D")) {
                            System.out.printf(B.get("D"));
                            bufferedWriter.write(B.get("D"));
                            LOC++;
                        }
                    }
                    System.out.println(" ");
